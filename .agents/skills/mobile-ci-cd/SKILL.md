...
name: Mobile Ci Cd
description: Mobile CI/CD automates building, testing, and deploying mobile applications.
  This guide covers GitHub Actions, Fastlane automation, code signing, and App Store
  submission automation for streamlining m
version: 1.0.0
status: active
owner: '@cerebra-team'
