---
id: SKL-adr-ADRTEMPLATES
name: Adr Templates
description: Architecture Decision Records (ADRs) are lightweight documents that capture
  important architectural decisions, their context, and consequences. They create
  a historical record of why systems are built
version: 1.0.0
status: active
owner: '@cerebra-team'
