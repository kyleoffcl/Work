...
> **[MANDATORY]** You MUST use `TaskCreate` to break ALL work into small tasks BEFORE starting — including tasks for each file read. This prevents context loss from long files. NEVER skip task creation.
