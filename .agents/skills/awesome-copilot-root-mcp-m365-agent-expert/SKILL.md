---
name: "awesome-copilot-root-mcp-m365-agent-expert"
...
- Use when: the task directly matches mcp m365 agent expert responsibilities within plugin awesome-copilot-root.
...
- Converted from `/tmp/codex-awesome-materialized-x3j3lxox/plugins/awesome-copilot-root/agents/mcp-m365-agent-expert.md`
