---
name: "typespec-m365-copilot-typespec-create-agent"
...
- Converted from `/tmp/codex-awesome-materialized-2f0wkne1/plugins/typespec-m365-copilot/skills/typespec-create-agent/SKILL.md`
