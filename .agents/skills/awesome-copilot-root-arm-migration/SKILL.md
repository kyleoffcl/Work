---
name: "awesome-copilot-root-arm-migration"
...
- Use when: the task directly matches arm migration responsibilities within plugin awesome-copilot-root.
...
- Converted from `/tmp/codex-awesome-materialized-x3j3lxox/plugins/awesome-copilot-root/agents/arm-migration.md`
