...
- Use when: the request is Django or DRF focused (models, migrations, admin, serializers, viewsets, manage.py).
- Do not use when: the request is FastAPI/Pydantic/SQLAlchemy specific or centered on GraphQL schema-first design.
...
- Converted from `~/code/agents/plugins/api-scaffolding/agents/django-pro.md`
