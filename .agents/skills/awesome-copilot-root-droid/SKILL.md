---
name: "awesome-copilot-root-droid"
...
- Use when: the task directly matches droid responsibilities within plugin awesome-copilot-root.
...
- Converted from `/tmp/codex-awesome-materialized-x3j3lxox/plugins/awesome-copilot-root/agents/droid.md`
