...
- Use when: the task directly matches openapi to application code responsibilities within plugin openapi-to-application-java-spring-boot.
...
- Converted from `/tmp/codex-awesome-materialized-2f0wkne1/plugins/openapi-to-application-java-spring-boot/skills/openapi-to-application-code/SKILL.md`
