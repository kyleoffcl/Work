---
name: "partners-stackhawk-security-onboarding"
...
- Use when: the task directly matches stackhawk security onboarding responsibilities within plugin partners.
...
- Converted from `/tmp/codex-awesome-materialized-2f0wkne1/plugins/partners/agents/stackhawk-security-onboarding.md`
