...
description: WebAssembly enables near-native performance in browsers, serverless,
  and edge computing with multiple languages (Rust, Go, C++). This skill covers WASM
  patterns, toolchains, and common use cases.
version: 1.0.0
status: active
owner: '@cerebra-team'
...
* **Success Criteria**:
  - WASM loads < 500ms
  - Function calls complete in expected time
  - Bundle size < target limit

## Skill Composition
* **Depends on**: Rust/Go/C++ toolchain, wasm-pack/TinyGo, bundler
* **Compatible with**: React, Vue, Angular, Edge platforms (Cloudflare, Vercel)
* **Conflicts with**: Pure JavaScript implementations
* **Related Skills**: [edge-cloud-sync](file://75-edge-computing/edge-cloud-sync/SKILL.md), [lightweight-kubernetes](file://75-edge-computing/lightweight-kubernetes/SKILL.md)
