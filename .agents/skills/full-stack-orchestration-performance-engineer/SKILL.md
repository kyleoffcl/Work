...
- Use when: the task directly matches performance engineer responsibilities within plugin full-stack-orchestration.
...
- Converted from `~/code/agents/plugins/full-stack-orchestration/agents/performance-engineer.md`
