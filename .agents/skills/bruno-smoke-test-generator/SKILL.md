...
description: Automatically generates Bruno (API testing tool) test collections from
  OpenAPI specs for smoke testing APIs. Bruno is a lightweight, open-source API testing
  alternative to Postman with text-based coll
version: 1.0.0
status: active
owner: '@cerebra-team'
...
* **Acceptance Evidence**:
  ...
  - Tests pass in CI/CD
* **Success Criteria**:
  - 100% of OpenAPI endpoints have tests
  - Tests run in < 1 minute
  - All assertions pass

## Skill Composition
* **Depends on**: [endpoint-generator](../endpoint-generator/SKILL.md)
* **Compatible with**: [ci-pipeline-generator](../ci-pipeline-generator/SKILL.md), [contract-test-gates](../68-quality-gates-ci-policies/contract-test-gates/SKILL.md)
* **Conflicts with**: None
* **Related Skills**: [service-scaffold-generator](../service-scaffold-generator/SKILL.md)
