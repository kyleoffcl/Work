---
name: "awesome-copilot-meta-agentic-project-scaffold"
...
- Use when: the task directly matches meta agentic project scaffold responsibilities within plugin awesome-copilot.
- Do not use when: a more specific framework or task-focused skill is clearly a better match.
...
- Converted from `/tmp/codex-awesome-materialized-x3j3lxox/plugins/awesome-copilot/agents/meta-agentic-project-scaffold.md`
