...
description: Automatically generates event contracts (schemas, types, validators)
  so that producers and consumers use the same event format. Ensures type safety and
