...
- Use when: the task directly matches performance engineer responsibilities within plugin observability-monitoring.
...
- Converted from `~/code/agents/plugins/observability-monitoring/agents/performance-engineer.md`
