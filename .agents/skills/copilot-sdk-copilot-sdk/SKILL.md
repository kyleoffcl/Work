...
- Use when: the task directly matches copilot sdk responsibilities within plugin copilot-sdk.
...
- Converted from `/tmp/codex-awesome-materialized-2f0wkne1/plugins/copilot-sdk/skills/copilot-sdk/SKILL.md`
