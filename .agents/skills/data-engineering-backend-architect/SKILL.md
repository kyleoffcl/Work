...
- Use when: the task directly matches backend architect responsibilities within plugin data-engineering.
...
- Converted from `~/code/agents/plugins/data-engineering/agents/backend-architect.md`
