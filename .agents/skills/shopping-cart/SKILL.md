...
name: Shopping Cart
description: A shopping cart is a critical component of any e-commerce system, allowing
  users to collect items for purchase. This guide covers various cart architectures
  and implementations, including guest carts,
version: 1.0.0
status: active
owner: '@cerebra-team'
...
## Skill Composition
* **Depends on**: [Product Catalog](30-ecommerce/product-catalog/SKILL.md), [Discount Promotions](30-ecommerce/discount-promotions/SKILL.md)
* **Compatible with**: [Order Management](30-ecommerce/order-management/SKILL.md), [Payment Gateways](30-ecommerce/payment-gateways/SKILL.md)
* **Conflicts with**: None
* **Related Skills**: [Checkout Flow](30-ecommerce/order-management/SKILL.md), [Cart Abandonment](30-ecommerce/shopping-cart/SKILL.md)
