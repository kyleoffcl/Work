...
description: "code reviews. Use when Codex needs this specialist perspective or review style."
---
...
Converted from `agents/nextjs-code-reviewer.md`.
...
- **Next.js Runtime Diagnostics:** Use `mcp__next-devtools__nextjs_runtime` to:
  ...
  - This is especially useful when reviewing code that might have runtime implications
