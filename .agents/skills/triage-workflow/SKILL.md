...
description: This skill provides standardized workflows for rapid incident triage
  and initial assessment. For comprehensive triage procedures, decision trees, and
  real-world scenarios, please refer to the main **I
version: 1.0.0
status: active
owner: '@cerebra-team'
...
* **Artifacts Required (Deliverables)**:
  ...
  - Triage checklist
* **Acceptance Evidence**:
  - All incidents triaged within time targets
  - Severity accuracy > 90%
  - Appropriate escalation rate
* **Success Criteria**:
  - Initial assessment < 5 minutes
  - Severity classification < 10 minutes
  - Severity accuracy > 95%

## Skill Composition
* **Depends on**: Incident Triage
* **Compatible with**: Severity Levels, Escalation Paths
* **Conflicts with**: Systems without clear severity definitions
* **Related Skills**: 
  - [41-incident-management/incident-triage](41-incident-management/incident-triage/SKILL.md) - Main skill with comprehensive triage coverage
  - [41-incident-management/severity-levels](41-incident-management/severity-levels/SKILL.md) - Severity classification
  - [41-incident-management/escalation-paths](41-incident-management/escalation-paths/SKILL.md) - Escalation decisions
