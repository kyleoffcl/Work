...
- Use when: the task directly matches tdd orchestrator responsibilities within plugin backend-development.
...
- Converted from `~/code/agents/plugins/backend-development/agents/tdd-orchestrator.md`
