...
- Use when: the task directly matches observability engineer responsibilities within plugin observability-monitoring.
...
- Converted from `~/code/agents/plugins/observability-monitoring/agents/observability-engineer.md`
