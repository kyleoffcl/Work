...
- Use when: the task directly matches network engineer responsibilities within plugin cloud-infrastructure.
...
- Converted from `~/code/agents/plugins/cloud-infrastructure/agents/network-engineer.md`
