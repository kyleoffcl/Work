...
description: Standards for managing environments (development, staging, production)
  including configs, data policies, and access controls that differ per environment.
  This skill enables environment parity, reduces
version: 1.0.0
status: active
owner: '@cerebra-team'
