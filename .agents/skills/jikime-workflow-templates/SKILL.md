---
name: jikime-workflow-templates
aliases: [jikime-workflow-templates]
...
status: "active"
replaces: jikime-core-code-templates, jikime-core-feedback-templates, jikime-project-template-optimizer
updated: 2026-01-11
...
triggers:
  ...
  phases: ["plan"]
  agents: ["manager-project", "command-builder", "skill-builder"]
...
- Creating GitHub issues with structured templates
- Optimizing template structures after JikiME-ADK updates
...
Integration: Used during project feedback and issue creation workflows.
...
Feedback Templates include Bug Report template, Feature Request template, Improvement template, Refactor template, Documentation template, Question template, and integration with feedback workflows.
...
- manager-spec: SPEC template generation
...
- /jikime:0-project: Project initialization with templates
...
Feedback Submission Workflow: Execute feedback workflow, select issue type using Pattern 2, fill template fields, and auto-generate GitHub issue.
...
- v2.0.0 (2025-11-24): Unified jikime-core-code-templates, jikime-core-feedback-templates, and jikime-project-template-optimizer into single skill with 5 core patterns
...
Generated with: JikiME-ADK Skill Factory
