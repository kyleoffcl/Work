---
name: "awesome-copilot-root-architecture-blueprint-generator"
...
- Use when: the task directly matches architecture blueprint generator responsibilities within plugin awesome-copilot-root.
...
- Converted from `/tmp/codex-awesome-materialized-x3j3lxox/plugins/awesome-copilot-root/skills/architecture-blueprint-generator/SKILL.md`
