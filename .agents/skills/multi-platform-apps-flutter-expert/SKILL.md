...
- Use when: the task directly matches flutter expert responsibilities within plugin multi-platform-apps.
...
- Converted from `~/code/agents/plugins/multi-platform-apps/agents/flutter-expert.md`
