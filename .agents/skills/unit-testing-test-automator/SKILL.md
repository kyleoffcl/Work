...
- Use when: the task directly matches test automator responsibilities within plugin unit-testing.
...
- Converted from `~/code/agents/plugins/unit-testing/agents/test-automator.md`
