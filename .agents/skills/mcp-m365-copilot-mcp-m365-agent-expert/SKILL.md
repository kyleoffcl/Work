---
name: "mcp-m365-copilot-mcp-m365-agent-expert"
...
- Use when: the task directly matches mcp m365 agent expert responsibilities within plugin mcp-m365-copilot.
...
- Converted from `/tmp/codex-awesome-materialized-2f0wkne1/plugins/mcp-m365-copilot/agents/mcp-m365-agent-expert.md`
