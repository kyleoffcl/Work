...
- Use when: the task directly matches context manager responsibilities within plugin agent-orchestration.
...
- Converted from `~/code/agents/plugins/agent-orchestration/agents/context-manager.md`
