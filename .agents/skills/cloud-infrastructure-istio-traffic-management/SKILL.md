...
- Use when: the task directly matches istio traffic management responsibilities within plugin cloud-infrastructure.
...
- Converted from `~/code/agents/plugins/cloud-infrastructure/skills/istio-traffic-management/SKILL.md`
