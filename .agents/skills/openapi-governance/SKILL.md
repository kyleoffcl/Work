---
id: SKL-openapi-OPENAPIGOVERNANCE
name: Openapi Governance
description: '* **Depends on**: None * **Compatible with**: None * **Conflicts with**:
  None * **Related Skills**: None # Overview Comprehensive guide to OpenAPI governance,
  API design standards, automated linting, '
version: 1.0.0
status: active
owner: '@cerebra-team'
...
- **Migration Guides**: Help users migrate
