...
- Use when: the task directly matches threat mitigation mapping responsibilities within plugin security-scanning.
...
- Converted from `~/code/agents/plugins/security-scanning/skills/threat-mitigation-mapping/SKILL.md`
